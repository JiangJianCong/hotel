 ...
 * @author 江回晖
 */
public class SignInSuccessFrame extends javax.swing.JFrame {

    /**
     * Creates new form SignInSuccess
     */
    public SignInSuccessFrame() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setBackground(new java.awt.Color(0, 76, 68));
    ...
    private void returnjButtonActionPerformed(java.awt.event.ActionEvent evt) {                                              
        ...
        new UserSignInFrame().setVisible(false);
        new InputAccountFrame(this,1).setVisible(true);
    }
